...
# Leyenda de escala del heatmap arriba y pequeña
st.markdown("### Escala del Heatmap")
if not df_filtrado.empty:
    ...
    st.markdown(
        '''<div style=\"height:18px; width:60vw; background: linear-gradient(to right, blue 0%, lime 40%, yellow 65%, red 100%); margin-bottom:2px;\"></div>
        <div style=\"display:flex; justify-content:space-between; width:60vw; font-size:11px;\">
